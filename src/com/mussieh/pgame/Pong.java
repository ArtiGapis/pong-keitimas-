 ...
 * of shapes.
 * @author Arturas Danilevicius
 * @version 11 November 2018
 */
public class Pong
{
   private static final String DIFFICULTY = "Lygis: ";
   private static final String RESTART = "Restart";
   private static final String SCORE_LABEL = "Taskai: 0";
   private static final String LIVES_LABEL = "   Bandymai: 3";
   ...
   public void displayScene()
   {
      ...
      restartButton.addActionListener(new
            ActionListener()
            {
               ...
               public void actionPerformed(ActionEvent event)
               {
                  ...
                  outerRectangle.setBodyColor(Color.green);
                  threadStarted = false;
      ...
      paddle.setBodyColor(Color.black);
